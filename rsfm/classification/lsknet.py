...
class LSKNet(nn.Module):
    def __init__(self, img_size=224, in_channels=3, num_classes=1000, embed_dim=64, embed_dims=[64, 128, 320, 512],
...
def lsknet_tiny(**kwargs):
    model = LSKNet(
        mlp_ratios=[8, 8, 4, 4], embed_dims=[32, 64, 160, 256],
...
def lsknet_small(**kwargs):
    model = LSKNet(
        mlp_ratios=[8, 8, 4, 4], embed_dims=[64, 128, 320, 512],
