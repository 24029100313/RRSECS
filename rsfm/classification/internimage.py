...
from rsfm.backbone.internimage.ops_dcnv3 import modules as opsm
...
class internimage_tiny(InternImage):
    def __init__(self, **kwargs):
        super(internimage_tiny, self).__init__(
            embed_dim=64, depths=[4, 4, 18, 4], groups=[4, 8, 16, 32], mlp_ratio=4., drop_path_rate=0.1,
            norm_layer='LN', layer_scale=None, offset_scale=1.0, post_norm=False, with_cp=False, **kwargs)

class internimage_small(InternImage):
    def __init__(self, **kwargs):
        super(internimage_small, self).__init__(
            embed_dim=80, depths=[4, 4, 21, 4], groups=[5, 10, 20, 40], mlp_ratio=4., drop_path_rate=0.4,
            norm_layer='LN', layer_scale=1e-5, offset_scale=1.0, post_norm=True, with_cp=False, **kwargs)

class internimage_base(InternImage):
    def __init__(self, **kwargs):
        super(internimage_base, self).__init__(
            embed_dim=112, depths=[4, 4, 21, 4], groups=[7, 14, 28, 56], mlp_ratio=4., drop_path_rate=0.5,
            norm_layer='LN', layer_scale=1e-5, offset_scale=1.0, post_norm=True, with_cp=False, **kwargs)
...
class internimage_large(InternImage):
    def __init__(self, **kwargs):
        super(internimage_large, self).__init__(
            ...
            norm_layer='LN', layer_scale=1e-5, offset_scale=2.0, post_norm=True, with_cp=False, **kwargs)
...
class internimage_huge(InternImage):
    def __init__(self, **kwargs):
        super(internimage_huge, self).__init__(
            ...
            center_feature_scale=True, use_clip_projector=True, with_cp=True, **kwargs)
