...
class InternImageBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if self.vlf_ris:
            self.fusion = build_ris_fusion(vlf_ris, channels, l_dim, num_heads_fusion, fusion_drop, **kwargs)

        # vision language fusion for vg
        self.vlf_vg = vlf_vg
        if self.vlf_vg:
            self.fusion = build_vg_fusion(vlf_vg, channels, l_dim, **kwargs)
