...
from timm.models.layers import to_2tuple, to_ntuple, trunc_normal_
from .utils import load_swinv2_checkpoint, PatchEmbed, PatchMerging, BasicLayer, LayerNormFP32
...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self,
        ...
        with_cp = to_ntuple(self.num_layers)(with_cp)
