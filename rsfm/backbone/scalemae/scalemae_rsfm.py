...
class ViT_scalemae(VisionTransformer):
    def __init__(self, **kwargs):
        super(ViT_scalemae, self).__init__(**kwargs)
    ...
    def forward(self, x, l=None, l_mask=None):
        ...
        num_patches = (self.img_size[0] // self.patch_size) * \
...
class vit_large_patch16_scalemae_rsfm(ViT_scalemae):
    def __init__(self, **kwargs):
        super(vit_large_patch16_scalemae_rsfm, self).__init__(
