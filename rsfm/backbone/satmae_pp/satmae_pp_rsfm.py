...
class ViT_satmae_pp(VisionTransformer):
    def __init__(self, **kwargs):
        super(ViT_satmae_pp, self).__init__(**kwargs)
        self.patch_size_tuple = (self.patch_size, self.patch_size)
        self.grid_size = tuple([s // p for s, p in zip(self.img_size, (self.patch_size, self.patch_size))])
...
class vit_large_patch16_satmae_pp_rsfm(ViT_satmae_pp):
    def __init__(self, **kwargs):
        super(vit_large_patch16_satmae_pp_rsfm, self).__init__(
