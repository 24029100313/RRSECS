...
import torch
from rsfm.utils import get_clones, get_activation_fn
...
def build_vl_transformer(vl_hidden_dim=256, vl_dropout=0.1, vl_nheads=8,
                         vl_dim_feedforward=2048, vl_enc_layers=1, vl_dec_layers=1):
    return VLTransformer(
        d_model=vl_hidden_dim,
        dropout=vl_dropout,
        nhead=vl_nheads,
        dim_feedforward=vl_dim_feedforward,
        num_encoder_layers=vl_enc_layers,
        num_decoder_layers=vl_dec_layers,
