...
class DeformableTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False):
        ...
        # self.query_encoder_layers = get_clones(query_encoder_layers, num_query_layers)
        self.num_layers = num_layers
...
def build_deforamble_transformer(embedding_dim=256, num_heads=8, enc_layers=4, dec_layers=4, dim_feedforward=2048,
                                 dropout=0.1, return_intermediate_dec=True, num_feature_levels=4,
                                 dec_n_points=4, enc_n_points=4, two_stage=False, num_queries=10):
