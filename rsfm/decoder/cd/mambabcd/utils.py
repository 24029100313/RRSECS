...
from rsfm.backbone.vmamba.utils import VSSBlock, Permute, LayerNorm2d
...
class ChangeDecoder(nn.Module):
    def __init__(self, encoder_dims, channel_first):
        ...
        self.st_block_41 = nn.Sequential(
            ...
            VSSBlock(hidden_dim=128, drop_path=0.1,  norm_layer=LayerNorm2d, channel_first=channel_first),
