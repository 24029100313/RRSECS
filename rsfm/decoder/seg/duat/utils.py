...
class GLSA(nn.Module):
    ...
    def __init__(self, input_dim=512, embed_dim=32):
        ...
        self.conv1_1 = CBR(embed_dim*2,embed_dim, 1)
...
class SBA(nn.Module):
    ...
    def __init__(self,input_dim = 64, output_dim = 7):
        ...
        self.d_in1 = CBR(input_dim//2, input_dim//2, 1)
        self.d_in2 = CBR(input_dim//2, input_dim//2, 1)       

        self.conv = nn.Sequential(CBR(input_dim, input_dim, 3,1,1),
